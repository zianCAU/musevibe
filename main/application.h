...
public:
     ...
     */
    int AddDeviceStateListener(DeviceStateMachine::StateCallback callback) {
    ...
    /**
     * Send affectionate touch message to AI in companion mode.
     * Opens audio channel if not open, then injects text as user input.
     */
    void SendCompanionTouch(const std::string& text);
