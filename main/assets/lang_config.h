...
namespace Lang {
    ...
    namespace Sounds {
        ...
        extern const char ogg_huahai_start[] asm("_binary_huahai_ogg_start");
        extern const char ogg_huahai_end[] asm("_binary_huahai_ogg_end");
        static const std::string_view OGG_HUAHAI {
        static_cast<const char*>(ogg_huahai_start),
        static_cast<size_t>(ogg_huahai_end - ogg_huahai_start)
        };
