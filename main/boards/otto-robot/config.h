...
// Otto机器人硬件版本配置
// ============================================================================
// OTTO_VERSION_AUTO      - 自动检测版本（通过检测摄像头是否存在）
// OTTO_VERSION_CAMERA    - 强制使用摄像头版本
// OTTO_VERSION_NO_CAMERA - 强制使用无摄像头版本
// ============================================================================
...
// 设置默认版本策略，可以在编译时通过 -D 参数覆盖
#ifndef OTTO_HARDWARE_VERSION
#define OTTO_HARDWARE_VERSION OTTO_VERSION_CAMERA
#endif
...
// 编译时保护：无摄像头版本的 GPIO4-7 被 I2S 麦克风/扬声器占用，不可用作触摸
#if defined(OTTO_HARDWARE_VERSION) && (OTTO_HARDWARE_VERSION == OTTO_VERSION_NO_CAMERA)
#error "TouchChordController requires CAMERA version (GPIO4-7 conflict with NON_CAMERA I2S)"
#endif
